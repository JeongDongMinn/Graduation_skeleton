...
#weightsFile ='/home/skysys/Downloads/openpose-master/models/pose/body_25/pose_iter_584000.caffemodel'
#protoFile = '/home/skysys/Downloads/openpose-master/models/pose/body_25/pose_deploy.prototxt'
BASE_DIR = 'C:'
...
class Detector:
    ...
    def count_people(self, image_name):
        detections = self.detect_img(image_name)
        cnt = 0
        for i in detections:
            if i[0] == 'person':
                cnt += 1
    ...
    def count_people_str(self, cnt):
        cnt = str(self.count_people(image))
        str1 = "count = " + cnt
        return str1
    ...
    def main_loop(self):
        while True:
            ...
            #self.str1 = count_people_str(self.count_people(image))
            cnt = str(self.count_people(image))
            self.str1 = "count = " + cnt
            #print(str1)
            ...
            #cv2.putText(self.result, str1, (20, 30), cv2.FONT_HERSHEY_PLAIN, 1, (255, 255, 255))
...
if __name__ == '__main__':
    ...
    while cv2.waitKey(1) < 0:
        ...
        print(detector.str1)
        cv2.putText(frame2, detector.str1, (20, 30), cv2.FONT_HERSHEY_PLAIN, 1, (255, 255, 255))
